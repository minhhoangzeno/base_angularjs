...
@Component({
  selector: 'cel-detail-event-version',
  templateUrl: './detail-event-version.component.html',
  styleUrls: ['./detail-event-version.component.scss'],
})
export class DetailEventVersionComponent implements OnChanges, OnInit, OnDestroy {
  ...
  readonly eventTypes = [
    { value: EventType.PROMOTION_CAMPAIGN, name: 'Promotion', disabled: true },
    { value: EventType.GENERAL_PRICING, name: 'Pricing Adjustment', disabled: true },
    { value: EventType.GENERAL_DEMAND, name: 'Demand Adjustment', disabled: true },
